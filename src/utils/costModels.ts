...
export function costModelObjectV2(model: Record<string, number>) {
   return [
      model['addInteger-cpu-arguments-intercept'],
      model['addInteger-cpu-arguments-slope'],
      model['addInteger-memory-arguments-intercept'],
      ...
      model['remainderInteger-memory-arguments-minimum'],
      model['remainderInteger-memory-arguments-slope'],
      model['serialiseData-cpu-arguments-intercept'],
      model['serialiseData-cpu-arguments-slope'],
      model['serialiseData-memory-arguments-intercept'],
      model['serialiseData-memory-arguments-slope'],
      model['sha2_256-cpu-arguments-intercept'],
      model['sha2_256-cpu-arguments-slope'],
      model['sha2_256-memory-arguments'],
      model['sha3_256-cpu-arguments-intercept'],
      ...
      model['unMapData-cpu-arguments'],
      model['unMapData-memory-arguments'],
      model['verifyEcdsaSecp256k1Signature-cpu-arguments'],
      model['verifyEcdsaSecp256k1Signature-memory-arguments'],
      ...
      model['verifySchnorrSecp256k1Signature-cpu-arguments-intercept'],
      model['verifySchnorrSecp256k1Signature-cpu-arguments-slope'],
      model['verifySchnorrSecp256k1Signature-memory-arguments'],
   ] as number[]
}